...
const EjemploUsoPageLayout: React.FC<AllProps> = ({ loginObject, newsItems, valuePortfolio, ordenes, resumen, graphPortfolio, historico, valuePortafolio, portfolio, getPermisosRespuesta }) => {
    ...
    */
    ...
    return(
        <PageLayout 
            ...
            titulo="Ejemplo Layout - Portafolio"
        />
    );
}
...
export default connect(mapStateToProps, mapDispatchToProps)(EjemploUsoPageLayout);